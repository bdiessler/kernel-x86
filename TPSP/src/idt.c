...
*/
// Aca, el segmento seleccionado siempre debe ser de nivel 0 porque es del kernel, el privilegio se define en el dpl
...
void idt_init() {
  ...
  //Aca son de nivel 0 porque interactuan con los pics, necesitando instrucciones como in y out que son de nivel 0.
  IDT_ENTRY0(32);
  IDT_ENTRY0(33);
  // COMPLETAR: Syscalls
  IDT_ENTRY3(88);
