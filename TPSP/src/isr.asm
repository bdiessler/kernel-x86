...
_isr14:
  ...
  mov EAX, CR2
  push EAX
  call page_fault_handler ; EAX tiene el booleano de si se pudo manejar el page fault
  add ESP, 4
  cmp AL, 0
  jne .fin
...
_isr32:
    ...
    ; aca se libera al pic para que pueda atender otra interrupcion
    call pic_finish1
    ; aca se va al proximo clock
    call next_clock
...
; aca no usamos pushad porque no calleamos ninguna funcion que pueda modificar los registros de proposito general
global _isr98
_isr98:
  mov eax, 0x62
  iret
