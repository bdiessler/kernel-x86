...
void screen_draw_layout(void) {
  ...
  print("Sistemas embebidos Inc.", (VIDEO_COLS/2 - 11), 0, 0x02);
  print("Un SO desarrollado por:", (VIDEO_COLS/2 - 11), 1, 0x02);
  screen_draw_box(20, 30, 10, 20, '-', 0x07);
  screen_draw_box(21, 31, 8, 18, ' ', 0x00);
  print("Aurora", (VIDEO_COLS/2 - 3), (VIDEO_FILS/2)-1, 0x0A);
  print("Berny", (VIDEO_COLS/2 - 2), VIDEO_FILS/2, 0x05);
  print("Joaquin", (VIDEO_COLS/2 - 3), VIDEO_FILS/2 + 1, 0x07);
}
